  ...
  private void mainGame(){
	...
	public void run(){
        ...
        //System.out.println("whats hah");
				ABC abc=new ABC(printer, sudoku,numEmp,numOnlook, numCycle, options.getPenaltyType());
            ...
            JOptionPane.showMessageDialog(frame, "Sudoku Generated");
				...
				status.setVisible(false);
				String cycle="", time="";
				ABC abc=new ABC(printer, board.getSudokuArray(),numEmp,numOnlook, numCycle, options.getPenaltyType());
				abc.start();
